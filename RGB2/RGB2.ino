...
void loop() {
  ...
  outRGB(analogOutPinR, analogOutPinG, analogOutPinB, outputValueR, outputValueG, outputValueB);
...
void outRGB(int analogOutPinR,int analogOutPinG,int analogOutPinB,int outputValueR,int outputValueG,int outputValueB){
